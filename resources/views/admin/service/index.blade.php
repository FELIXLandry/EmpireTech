...
<div class="card">
    <div class="card-header" style="background-color: #1977cc; color: white;">
        <h4 style="font-weight: lighter;letter-spacing: 2px;">
            <i class="fa fa-tag"></i> GESTION DES SERVICES <i class="fa fa-users"></i>
    ...
    <div class="card-body">
        <table class="table table-hover table-bordered table-striped table-sm">
            ...
            <tbody>
                ...
                <tr>
                    <td class="nom"> <a class="a" href="{{ route("services.show",$service->id) }}"> {{ $service->label }} </a> </td>
                </tr>
                @endforeach
            </tbody>
        </table>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">AJOUT D'UN SERVICE</h5>
            ...
            <div class="modal-body">
                <form action="{{ route('services.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row mt-2">
                        <div class="col-md-12">
                            <textarea class="form-control" name="description" id="" rows="5" placeholder="description sur le service"></textarea>
                        </div>
                    </div>
